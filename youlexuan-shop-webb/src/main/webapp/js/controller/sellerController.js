...
app.controller('sellerController' ,function($scope,$controller   ,sellerService){	
	...
	$scope.getUserName = function(){
		sellerService.getUserName().success(function(response){
			$scope.loginName=response.loginName;
		});
	}
	//$scope.oldPwd能够取得到
	$scope.changePwd = function(oldPwd,newPwd,Pwd){
		sellerService.changePwd(oldPwd,newPwd,Pwd).success(function(response){
