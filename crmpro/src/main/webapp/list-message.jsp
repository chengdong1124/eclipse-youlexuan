        ...
        <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-content mailbox-content">
                        <div class="file-manager">
                            <a class="btn btn-block btn-primary compose-mail" href="${pageContext.request.contextPath}/save-message.jsp"><i class="fa fa-paper-plane"></i>&nbsp;&nbsp;写信</a>
                            ...
                            <ul class="folder-list m-b-md" style="padding: 0">
                                ...
                                <li>
                                    <a href="mailbox.jsp"> <i class="fa fa-file-text-o"></i> 草稿 <span class="label label-danger pull-right">${draft }</span></a>
                                </li>
                                <li>
                            ...
                            <ul class="category-list" style="padding: 0">
                                ...
                                <li>
                                    <a href="${pageContext.request.contextPath}/message/list?type=2"><i class="fa fa-circle text-primary"></i> 文件</a>
                                </li>
                                <li>
            ...
            <div class="col-sm-9 animated fadeInRight">
                <div class="mail-box-header">
                    ...
                    <form method="post" action="${pageContext.request.contextPath}/message/list" class="pull-right mail-search">
                        <div class="input-group">
                            <input name="key" type="text" class="form-control input-sm" name="search" placeholder="搜索标题">
                ...
                <div class="mail-box">
                    ...
                    <table class="table table-hover table-mail">
                        ...
                        <c:forEach items="${list }" var="message">
                            <tr class="unread">
                                <td class="check-mail">
                                    <input type="checkbox" value="${message.msgid }">
                                </td>
                                <td class="mail-ontact">
                                <a href="${pageContext.request.contextPath}/message/show?id=${message.msgid }">
                               		<c:if test="${message.title.length()>8 }">
	                   						${message.title.substring(0,8).replaceAll("<p>","").replaceAll("</p>","") }...
	                   				</c:if>
	                   				<c:if test="${message.title.length()<=7 }">
	                   						${message.title.replaceAll("<p>","").replaceAll("</p>","") }
	                   				</c:if>
                                </a>
                                ...
                                <td class="mail-subject">
                                	<a href="${pageContext.request.contextPath}/message/show?id=${message.msgid }">
                                	<c:if test="${message.content.length()>20 }">
	                   						${message.content.substring(0,20).replaceAll("<p>","").replaceAll("</p>","") }...
	                   				</c:if>
	                   				<c:if test="${message.content.length()<=20 }">
	                   						${message.content.replaceAll("<p>","").replaceAll("</p>","") }
	                   				</c:if>
	                   				
	                   				</a>
                                </td>
                                <td class="">
                                	<c:if test="${message.path != null and message.path != '' }">
