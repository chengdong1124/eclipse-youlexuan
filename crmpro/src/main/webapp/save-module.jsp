                    ...
                    <div class="ibox-content">
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                	<input type="hidden" id="analysisid" name="analysisFk" />
                                    <input id="analysis" class="selectpicker form-control" readonly="readonly" />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                         ...
                         <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                	<a href="list-module.jsp" class="btn btn-white"><i class="fa fa-reply"></i> 返回</a>
                                </div>
                            </div>
                       </div>
                       </form>
	...
	$(document).ready(function() {
		...
		$("#project").change(function(){
			...
			$.post("${pageContext.request.contextPath}/analysis/getbyid",{"id":id},function(result){
				if(result!=null){ //返回的是个json里面包含的是个对象，所以用null
		...
		$("#level").change(function(){
			$(".btnSave").prop("disabled",false); //这种方法有瑕疵
		});
