                    ...
                    <div class="ibox-content">
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3 show-text">
                                    <fmt:formatDate value="${archives.graudatetime }" pattern="yyyy/MM/dd"/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3 show-text">
                                	<fmt:formatDate value="${archives.hiredate }" pattern="yyyy/MM/dd"/>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="form-group">
                                <div class="col-sm-12 text-center">
                                	<a href="javascript:history.back()" class="btn btn-white">返回</a>
                                </div>
                            </div>
                       </div>
                       </form>
