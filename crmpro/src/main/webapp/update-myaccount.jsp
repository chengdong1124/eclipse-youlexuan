                    ...
                    <div class="ibox-content">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <select name="paymode" class="selectpicker form-control">
										<option <c:if test="${account.paymode=='出差票据' }">selected="selected"</c:if> value="出差票据">出差票据</option>
										<option <c:if test="${account.paymode=='办公采购' }">selected="selected"</c:if> value="办公采购">办公采购</option>
										<option <c:if test="${account.paymode=='其他' }">selected="selected"</c:if> value="其他">其他</option>
									</select>
                                ...
                                <div class="col-sm-3">
                                    <!--时间控件的id都不能改-->
                                    <input value="<fmt:formatDate value='${account.bxtime }' pattern='yyyy-MM-dd'/>" name="bxtime" id="start" class="laydate-icon form-control layer-date">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input value="${account.totalmoney }" name="totalmoney" type="text" class="form-control" >
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea name="bxremark" class="form-control">${account.bxremark }</textarea>
                                </div>
                            </div>
                        </div>
   ...
   <script>
	$(document).ready(function() {
		...
		$(".btnSave").click(function(){
			...
			$.post("${pageContext.request.contextPath}/account/update",data,function(result){
