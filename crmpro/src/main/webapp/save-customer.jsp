            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>客户信息管理<small>>添加客户信息</small></h5>
                    </div>
                    <div class="ibox-content">
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                   <input placeholder="必填" name="comname" type="text" class="form-control input-sm notnull">
                                </div>
                                <label class="col-sm-2 col-sm-offset-1 control-label">公司联系人</label>
                                <div class="col-sm-3">
                                    <input placeholder="必填" name="companyperson" type="text" class="form-control input-sm notnull">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                   <input placeholder="必填" name="comphone" type="text" class="form-control input-sm notnull">
                                </div>
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                   <input placeholder="必填" name="comaddress" type="text" class="form-control input-sm notnull">
                                </div>
                            </div>
                        </div>
   ...
   <script>
	$(document).ready(function() {
		...
		$(".btnSave").click(function(){
			...
			$.post("${pageContext.request.contextPath}/customer/save",data,function(result){
				if(result=="true"){
					swal("添加成功！", "客户信息添加成功", "success");
				}else{
					swal({
						title: "添加失败",
