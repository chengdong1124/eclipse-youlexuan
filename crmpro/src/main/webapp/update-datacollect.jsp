                        ...
                        <input type="hidden" name="daid" value="${datacollect.daid }" />
                       	<div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input value="${datacollect.dacname }" name="dacname" type="text" class="form-control input-sm">
                                </div>
                                <label class="col-sm-2 col-sm-offset-1 control-label">营业额</label>
                                <div class="col-sm-3">
                                    <input value="${datacollect.daturnover }" name="daturnover" type="text" class="form-control input-sm">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                     <input value='<fmt:formatDate value="${datacollect.datime }" pattern="yyyy/MM/dd"/>' name="datime" id="datime" class="laydate-icon form-control layer-date">
                                </div>
                                
                                <label class="col-sm-2 col-sm-offset-1 control-label">员工数量</label>
                                <div class="col-sm-3">
                                    <input value="${datacollect.empcount }" name="empcount" type="text" class="form-control input-sm">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input value="${datacollect.dasort }" name="dasort" type="text" class="form-control input-sm">
                                </div>
                                <label class="col-sm-2 col-sm-offset-1 control-label">创建时间</label>
                                <div class="col-sm-3">
                                    <input value='<fmt:formatDate value="${datacollect.buildtime }" pattern="yyyy/MM/dd"/>' name="buildtime" id="finish" class="laydate-icon form-control layer-date">
                                </div>
                            </div>
                        </div>
   ...
   <script>
	$(document).ready(function() {
		...
		$(".btnSave").click(function(){
			...
			$.post("${pageContext.request.contextPath}/datacollect/update",data,function(result){
				if(result=="true"){
					swal({title:"修改成功",text:"修改恭喜，修改成功",type:"success"},function(){
						location.href="${pageContext.request.contextPath}/datacollect/list";
					});
				}else{
					swal("修改失败","这可咋办","warning");
				}
			},"text");
		});
