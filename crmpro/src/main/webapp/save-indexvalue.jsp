                     	...
                     	<form id="addform" method="get" action="#" class="form-horizontal">
                       	<div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input name="turnover" type="text" class="form-control input-sm">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input name="business" type="text" class="form-control input-sm">
                                </div>
	...
	$(document).ready(function() {
		...
		$("#dacname").change(function(){
			...
			$.post("${pageContext.request.contextPath}/datacollect/getbyid",{"id":id},function(result){
				if(result!=null){	//当json返回的是一个对象的时候好像不用遍历直接用result.dacname,当然遍历了也可以的
					$(result).each(function(){
						$("#pname").html(this.dacname);	//因为前面是div不是input输入框
		...
		$(".btnSave").click(function(){
			$.ajax({ 
				url: "${pageContext.request.contextPath}/indexvalue/save", 
				type: "POST",
				dataType:"text",
				cache: false, 
