                    ...
                    <div class="ibox-content">
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input name="graudatetime" id="finish" class="laydate-icon form-control layer-date">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input name="eductaion" type="text" class="form-control input-sm">
                                </div>
                                <label class="col-sm-2 col-sm-offset-1 control-label">政治面貌</label>
                                <div class="col-sm-3">
                                    <input name="policstatus" type="text" class="form-control input-sm">
                                </div>
                            </div>
                        </div>
                        <div class="row">
   ...
   <script>
	$(document).ready(function() {
		...
		$(".btnSave").click(function(){
			...
			$.post("${pageContext.request.contextPath}/archives/save",data,function(result){
				if(result=="true"){
					swal({
				        title: "添加成功",
				        text: "添加成功，恭喜恭喜！",
