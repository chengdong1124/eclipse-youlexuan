                    ...
                    <div class="ibox-content">
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-sm-3 show-text">
                                  	<fmt:formatDate value="${account.bxtime }" pattern="yyyy-MM-dd"/>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 show-text">
                                   <c:if test="${account.bxstatus!=1 }"> ${account.result }</c:if>
                                   <c:if test="${account.bxstatus==1 }"> 待审批中。。。</c:if>
                                </div>
                            </div>
                        </div>
                     	<div class="row">
                        ...
                        <div class="row">
                            <div class="form-group">
                                <div class="col-sm-3 col-sm-offset-4">
                                	<a href="${pageContext.request.contextPath}/account/mylist?pageNum=${pageNum }" class="btn btn-white">返回</a>
                                	</div>
                            </div>
                       </div>
                       </form>
