...
public class Customer {
	...
	public String toString() {
		return "Customer [id=" + id + ", comname=" + comname + ", companyperson=" + companyperson + ", comaddress="
				+ comaddress + ", comphone=" + comphone + ", camera=" + camera + ", present=" + present + ", remark="
				+ remark + ", addtime=" + addtime + ", ids=" + ids + "]";
	}
