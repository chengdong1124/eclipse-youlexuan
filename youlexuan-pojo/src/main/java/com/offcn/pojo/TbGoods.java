...
public class TbGoods implements Serializable{
    ...
    private String itemCatName1;
    private String itemCatName2;
    private String itemCatName3;
	...
	public String getItemCatName2() {
		return itemCatName2;
	}

	public void setItemCatName2(String itemCatName2) {
		this.itemCatName2 = itemCatName2;
	}

	public String getItemCatName3() {
		return itemCatName3;
	}

	public void setItemCatName3(String itemCatName3) {
		this.itemCatName3 = itemCatName3;
	}

	public String getItemCatName1() {
		return itemCatName1;
	}

	public void setItemCatName1(String itemCatName1) {
		this.itemCatName1 = itemCatName1;
	}
	...
	public String toString() {
		return "TbGoods [id=" + id + ", sellerId=" + sellerId + ", goodsName=" + goodsName + ", defaultItemId="
				...
				+ typeTemplateId + ", isEnableSpec=" + isEnableSpec + ", isDelete=" + isDelete + ", itemCatName1="
				+ itemCatName1 + ", itemCatName2=" + itemCatName2 + ", itemCatName3=" + itemCatName3 + "]";
	}
