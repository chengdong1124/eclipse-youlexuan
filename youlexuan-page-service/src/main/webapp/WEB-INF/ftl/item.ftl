...
<head>
	...
	<script src="/js/base/base_nopagination.js"></script>
			...
			<div class="product-info">
				<div class="fl preview-wrap">
					...
					<div class="zoom">
						...
						<#if (imageList?size>0) >
							<span class="jqzoom"><img jqimg="${imageList[0].url}" src="${imageList[0].url}" width="400px" height="300px" /></span>
						</#if>
						</div>
						<!--下方的缩略图-->
					...
					<div class="summary">
						...
						<div class="summary-wrap">
							...
							<div class="fl fix-width">
								...
								<em class="t-gray">${goodsDesc.introduction}</em>
							</div>
						</div>
					</div>
					<div class="support">
						<div class="summary-wrap">
							...
							<div class="fl fix-width">
								<em class="t-gray">${goodsDesc.saleService}</em>
							</div>
						</div>
						<div class="summary-wrap">
							<div class="fl title">
                    ...
                    <div class="clearfix choose">
                        ...
                        <div id="specification" class="summary-wrap clearfix">
                            <dl>
                                ...
                                <dd>
									<#list itemImagesList as itemImages>
										<#if itemImages.color ??>
											<a href="javascript:;" ng-click="selectItemsImages('color','${itemImages.color}')" class= "{{isItemsImagesSelected('color','${itemImages.color}')?'selected':''}}">
                                                ${itemImages.color}
                                ...
                                <dl>
                                    ...
                                    <dd>
                                        <#list specification.attributeValue as item>
                                            <a href="javascript:;" ng-click="selectSpecList('${specification.attributeName}','${item}')" class="{{isSelected('${specification.attributeName}','${item}')?'selected':''}}">
                                                ${item}
                                                <span title="点击取消选择">&nbsp;</span>
                                            </a>
                                        </#list>
						...
						<div class="summary-wrap">
							...
							<div class="fl">
								<ul class="btn-choose unstyled">
									<li>
										<a href="#" ng-click="addCart()" target="_blank" class="sui-btn  btn-danger addshopcar">加入购物车</a>
									</li>
								</ul>
							</div>
						</div>
